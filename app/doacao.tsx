        ...
        <View style={styles.cards}>
          <View style={styles.card}>
            <Image
              ...
              source={{
                uri: "https://s2-g1.glbimg.com/St9bNFOVVt0ptEfCqC8j-tIy5EY=/0x0:1270x800/984x0/smart/filters:strip_icc()/i.s3.glbimg.com/v1/AUTH_59edd422c0c84a879bd37670ae4f538a/internal_photos/bs/2022/Z/4/w5aD04SZmwb4oqvnfIAQ/gatinha-resgatada.jpg",
              }}
            />
            <Text style={styles.cardTitle}>Sol</Text>
            <Text style={styles.cardText}>
              Resgatada recentemente, precisa de vacinas e alimentação.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            <Image
              style={styles.cardImage}
              source={{
                uri: "https://fotos.amomeupet.org/uploads/fotos/1683120795_6452629b6bc47_hd.jpg",
              }}
            />
            <Text style={styles.cardTitle}>Max</Text>
            <Text style={styles.cardText}>
              Recuperando-se de um acidente, precisa de tratamento veterinário.
            </Text>
          </View>
          ...
          <View style={styles.card}>
            <Image
              style={styles.cardImage}
              source={{
                uri: "https://fotos.amomeupet.org/uploads/fotos/1628182658_610c18828d55d_hd.jpeg",
              }}
            />
            <Text style={styles.cardTitle}>Mimi</Text>
            <Text style={styles.cardText}>
              Filhote em busca de um lar, precisa de leite e cuidados.
            </Text>
          </View>
        </View>
      </View>
      <View style={styles.section}>
        <View style={styles.doacaoCard}>
          <View style={styles.doacaoTexto}>
            ...
            <Text>
              🐾 Acolhimento: espaço seguro e limpo para os pets resgatados.
            </Text>
